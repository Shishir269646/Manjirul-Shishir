        ...
        >
            <div className="mb-4">
                <input
                    type="text"
                    required
                    className="min-h-[48px] leading-[48px] bg-blueColor border border-transparent rounded-xl focus:outline-none focus:border focus:border-white w-full px-5"
            ...
            <div className="text-end">
                <button
                    type="submit"
                    className="px-4 py-2 text-xl text-white transition bg-btnColor rounded-md h-14 w-44 hover:bg-blueColor font-bold ring-2 ring-white"
                >
                    Send
                </button>
            </div>
...
const Contact = () => {
    return (
        <section
            id="contact"
            className="py-10 md:py-14 bg-bgColor dark:bg-[#0b1727] text-white overflow-hidden"
        >
                ...
                <div className="grid grid-cols-12">
                    ...
                    <div className="col-span-12 lg:col-span-6 mb-4 lg:mb-0">
                        <div className="h-full flex items-center">
                            <div className="max-w-full bg-cardColor shadow-2xl h-2/3 relative z-[2] rounded-tr-[100px] rounded-br rounded-bl-[100px] mx-auto">
                                <div className="grid grid-cols-12">
                    ...
                    <div className="col-span-12 lg:col-span-6 xl:col-span-5 px-6 relative">
                        <div className="absolute top-0 left-0 lg:-left-[20%] right-0 bottom-0 bg-cardColor shadow-2xl rounded-tl rounded-tr-[30px] rounded-br-[150px] rounded-bl-[50px]"></div>
                        ...
                        <div className="relative rounded my-12">
                            <div className="mb-12">
                                <div className="col-span-12 w-full text-center sm:text-start mb-12">
                                    ...
                                    <div className="w-40 h-1 items-center bg-white my-10 mx-auto mb-16"></div>
